...
export function ThemeSelector(props: any) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-green-400 [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-green-400 [[data-theme=dark]_&]:block" />
            ...
            className={({ active, selected }) =>
              clsx(
                'flex cursor-pointer select-none items-center rounded-[0.625rem] p-1',
                {
                  ...
                  'bg-slate-100 dark:bg-primary/40': active,
                }
              )
            }
          >
